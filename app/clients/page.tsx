...
{
  id: "crystalline",
  name: "Crystal Line Aluminum & Glass",
  logoUrl: "https://tpxyegbeluspgashouzb.supabase.co/storage/v1/object/public/avatars/crystalline-logo.jpg",
  niche: "Real Estate & Construction",
  package: "Social Media Management + Website Build",
  retainerAED: 5500,
  discountedRate: 3000,
  fullRateDate: "2026-08-01",
  services: "15 short-form videos/month\nFull social media management\nWebsite build & hosting\nMeta Ads management\nNo on-camera client requirement",
  contactName: "Ammar Qais",
  contactEmail: "ammarqais002@gmail.com",
  contactWhatsApp: "+971 52 138 1970",
  contactInstagram: "@crystalline.dxb",
  startDate: "2026-05-18",
  notes: "",
  billToCompany: "Crystal Line Aluminum & Glass CONT. LLC",
  billToAddress: "Crystal Line Aluminum & Glass Cont. LLC\nshed no 25, industrial area 15, Maleha RD, Sharjah",
  billToTrn: "",
  invoiceEmails: "accounts@cagllc.me",
  invoiceCc: "ammarqais002@gmail.com",
  invoicePrefix: "CAG",
  invoiceDesc: "Social Media Management & Website Build",
  invoiceNotes: "15 short-form videos/month\nFull social media management\nWebsite build (Month 1)\nContent strategy & planning",
},
{
  id: "pets-delight",
  name: "Pets Delight",
